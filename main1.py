...
if __name__ == '__main__':
    ...
    mqttClient = iot.getAliyunIotMqttClient(aliyun_config['productKey'], aliyun_config['deviceName'],
                                            ...
                                            secure_mode=3)
    _thread.start_new_thread(thread1_human, ())
    _thread.start_new_thread(thread2_smoke, ())
    _thread.start_new_thread(thread3_dht11, ())
    _thread.start_new_thread(thread4_video, ())
    _thread.start_new_thread(thread5_mqtt, ())
    verify()
